...
#    #print(minus.bigWig)
#    }
for (replicate.plus.bigWig in Sys.glob(file.path("*_rep*_plus_PE1.bigWig"))) { # name changed
   	#print(replicate.plus.bigWig)
   	replicate.prefix = strsplit(replicate.plus.bigWig, '_plus_PE1.bigWig')[[1]][1] # name changed
	replicate.minus.bigWig = paste0(strsplit(replicate.prefix, '_plus_PE1.bigWig')[[1]][1], "_minus_PE1.bigWig") # name changed
