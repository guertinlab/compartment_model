...
The output file `paramEstimationResults_TRP_12.5min_vs_baseline.txt` contains normalized pause and body densities for all the genes, along with different rates that can be calculated using these normalized values (see Mukherjee & Guertin, 2025 for equations). The column names are self-explanatory:-
```{r, engine='bash',  comment=''}
