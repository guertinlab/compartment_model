...
* control all genes data for, `testData_TRP12min_All_control_genes.txt`: raw file [link](https://github.com/guertinlab/compartment_model/blob/main/compModel_vignette/testData_TRP12min_All_control_genes.txt).
