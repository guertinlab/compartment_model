...
* control data, `testData_TRP12min_control.txt`: raw file [link](linktoadd).
* treatment data, `testData_TRP12min_control.txt` : raw file [link](linktoadd).
* control all genes data for, `testData_TRP12min_All_control_genes.txt`: raw file [link](linktoadd).
