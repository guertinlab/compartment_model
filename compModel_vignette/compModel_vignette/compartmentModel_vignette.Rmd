...
Note: This section assumes that user already has genes of interest with their pause sums and body densities. Please refer to section `Preparation of Inputs` for creation of these input files. These input files are present in the [Github directory] (https://github.com/guertinlab/compartment_model/tree/master/compModel_vignette/compModel_vignette). 
